...
def main():
    ...
    parser.add_argument('max_alu', metavar='max_alu', nargs=1,
                        help='Max ALU instructions')
    parser.add_argument('min_mem_dist', metavar='min_mem_dist', nargs=1,
                        help='Min MEM distance')
    parser.add_argument('max_mem_dist', metavar='max_mem_dist', nargs=1,
                        help='Max MEM distance')
    ...
    min_mem_dist = args.min_mem_dist[0]
    max_mem_dist = args.max_mem_dist[0]
